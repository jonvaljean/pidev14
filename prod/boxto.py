...
if __name__ == "__main__":
	...
	if dali_device == 255:
		DaliBus_Bar1.SetDaliAddress(defs.LW14_BROADCAST, defs.LW14_ADR_GROUP, defs.LW14_MODE_DACP)	
	else:
		DaliBus_Bar1.SetDaliAddress(dali_device, defs.LW14_ADR_SINGLE, defs.LW14_MODE_DACP)
