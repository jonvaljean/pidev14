...
LW14_I2C_ADDRESS_1	= 0x23 #7Bit default address from LW14 Left Reg
LW14_I2C_ADDRESS_2  = 0x2f #7Bit address for 2nd LW14 Right Reg
LW14_I2C_ADDRESS_3	= 0x27 #7Bit Front
LW14_I2C_ADDRESS_4	= 0x2b #7Bit Back
...
dali_tab = [(5,200),(7,200),(0,200),(8,180),(4,190),(3,150),(6,200)]
...
if __name__ == "__main__":
	...
	for i,j in dali_tab:
		...
		DaliBus_Bar1.SetI2cBus(LW14_I2C_ADDRESS_3)									#Set I2C-Address to the class
		DaliBus_Bar1.SetDaliAddress(dali_device, LW14_ADR_SINGLE, LW14_MODE_CMD)	#Set the dali address for send data, in this case single device and DACP bit
