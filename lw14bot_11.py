...
if __name__ == "__main__":
	...
	def lw14_group():
		...
		subprocess.Popen(["./lwturngrpto.py", g_id, g_intensity],stdout=subprocess.PIPE)
		redirect("/lw14ask")
	...
	def lw14_single():
		...
		subprocess.Popen(["./lwturnboxto.py", s_id, s_intensity],stdout=subprocess.PIPE)
		redirect("/lw14ask")
	...
	def cycle():
		...
		subprocess.Popen(["./lwcycler_test2.py", c_script,c_high, c_low],stdout=subprocess.PIPE)
		redirect("/lw14ask")
